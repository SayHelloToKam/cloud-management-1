      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <HiOutlinePhone className='w-16 px8 py-8 bg-indigo-600 text-white rounded-lg mt-[-4rem]' />
              ...
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <HiSupport className='w-16 px8 py-8 bg-indigo-600 text-white rounded-lg mt-[-4rem]' />
              ...
              <div className='bg-white rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <HiChip className='w-16 px8 py-8 bg-indigo-600 text-white rounded-lg mt-[-4rem]' />
